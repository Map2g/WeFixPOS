  ...
  <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-4">
            ...
            <div class="col-5">
                <input type="text" name="prodSearch" class="form" placeholder="Search">
            </div>
            
            <div class="col-3">
                <a href = "pages/AddProd.html"><button type="button">&plus; Product</button></a>
            </div>
        ...
        <div class="col-lg-9">
          ...
          <table class="table">
              ...
              <tbody>
                ...
                <?php include 'queries/ProdList.php'; ?>
